...
public class SystemOSUtil {
     ...
     * 系统名称key
     */
    final public static String OS_NAME = "os.name";
    final public static String LINUX = "LINUX";
    final public static String WINDOWS = "WINDOWS";
    final public static String MAC = "MAC";
     ...
     */
    public static boolean isNotWindow() {
        return !isWindow();
    }
     ...
     * @return boolean
     */
    public static boolean isOS(String osType) {
    ...
    public static void getDiskInfoByPath() {
    ...
    public static Map getWindowDiskInfo(String path) {
    ...
    //@SuppressWarnings("unchecked")
    public static Map getLinuxDiskInfo(String path) {
        Map map = new HashMap(16);
        try {
